...
//        remoteController = new RemoteController(RemoteControlAppContext.INSTANCE.getContext(), new MusicReceiveService());
//        ((AudioManager) PresenterAppContext.INSTANCE.getContext().getSystemService(AUDIO_SERVICE)).registerRemoteController(remoteController);
    }
...
//            if (m.getPackageName().equals("com.kugou.android") && m.getPlaybackState() != null) {
                {
