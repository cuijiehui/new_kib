...
public interface PMSPCall {
     ...
     * @param powerL28T 电量
     */
    void setPowerL28T(int powerL28T);
     ...
     * @return 预设睡眠开关
     */
    boolean getPresetSleepSwitch();

    /**
     * 设置预设睡眠开关
     *
     * @param presetSleepSwitch 预设睡眠开关
     */
    void setPresetSleepSwitch(boolean presetSleepSwitch);
